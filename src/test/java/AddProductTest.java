...
//        driver.findElement(By.name("save")).click();
        ...
        driver.findElement(By.cssSelector("trumbowyg-editor")).sendKeys("This is description");
        driver.findElement(By.cssSelector("head_title[en]")).sendKeys("Super toy");
        driver.findElement(By.cssSelector("meta_description[enr")).sendKeys("This is meta description");
